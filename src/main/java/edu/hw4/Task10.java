...
public class Task10 {
    ...
    /**
     * All animals with age not equal to their number of paws
     *
     * @param animals Animals
     * @return The list of animals with age not equal to their number of paws
     */
    static List<Animal> ageIsNotEqualPaws(List<Animal> animals) {
    ...
    public static void main(String[] args) {
        ...
        var filter = ageIsNotEqualPaws(animals);
