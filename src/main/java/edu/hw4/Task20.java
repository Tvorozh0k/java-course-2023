...
public class Task20 {
     ...
     */
    static Map<String, String> errorsAnimals(List<Animal> animals) throws IllegalArgumentException {
        ...
        return animals.stream()
            .collect(Collectors.toMap(
                Animal::name,
                animal -> errorsAnimal(animal).stream()
            ...
            .collect(Collectors.toMap(Map.Entry::getKey,
                a -> a.getValue().substring(0, 1).toUpperCase() + a.getValue().substring(1)));
    }
