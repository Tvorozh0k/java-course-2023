...
public class Task8 {
    ...
    /**
     * The most weighted animal among animals with < k cm height
     *
     * @param animals Animals
     * @param k the height bound
     * @return The most weighted animal among animals with < k cm height
     */
    static Optional<Animal> belowKMostWeighted(List<Animal> animals, int k) throws IllegalArgumentException {
        if (k <= 0) {
            throw new IllegalArgumentException("Ошибка: рост может быть только положительным числом");
        }
    ...
    public static void main(String[] args) {
        ...
        var animal = belowKMostWeighted(animals, 5);
